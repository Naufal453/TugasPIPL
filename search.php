            ...
            <ul class="navbar-nav ms-auto">
                <li class="nav-item">
                    <button class="nav-link active"
                        style="background-color:#E3FEF7;border:transparent;border-radius:35px;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);"
                        aria-current="page" href="#">
                        <img style="width:36px;height:36px;" src="image\icons8-home-480.png" href="#">
                        <div
                            style="position: absolute; background-color: #E3FEF7; width: 10px; height: 10px; border-radius: 50%;margin-left:13px;margin-top:10px;">
                        </div>
                    </button>
                </li>
                <li class="nav-item">
